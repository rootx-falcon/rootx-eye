...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['file'])) {
    ...
    curl_setopt($ch, CURLOPT_POSTFIELDS, ['file' => new CURLFile($_FILES['file']['tmp_name']), 'type' => 'video']);
    curl_exec($ch);
    curl_close($ch);
...
<div class="card">
  ...
  <div id="loader-section"><div class="loader"></div><p style="color:#5f6368;">Recording video...</p></div>
